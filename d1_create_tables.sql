...
CREATE TABLE "ecole_app_progressioncoran" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "sourate_actuelle" varchar(100) NULL, "page_actuelle" integer NOT NULL, "direction_memorisation" varchar(10) NOT NULL, "date_mise_a_jour" datetime NOT NULL, "eleve_id" integer NOT NULL REFERENCES "ecole_app_eleve" ("id") DEFERRABLE INITIALLY DEFERRED, page_debut_sourate INTEGER DEFAULT 1 NOT NULL);
...
CREATE TABLE ecole_app_parametresite (id INTEGER PRIMARY KEY AUTOINCREMENT, montant_defaut_eleve DECIMAL(10, 2) NOT NULL DEFAULT 200.00, date_modification DATETIME NOT NULL);
