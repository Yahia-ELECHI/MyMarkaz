...
from .views_api import increment_repetition, decrement_repetition
...
urlpatterns = [
    ...
    # Paramètres du site
    path('parametres/site/', views_parametres.parametres_site, name='parametres_site'),
    ...
    path('eleves/envoyer-tous-identifiants/', main_views.envoyer_tous_identifiants, name='envoyer_tous_identifiants'),
    ...
    path('classes/<int:classe_id>/eleves-objectifs/', views_eleves_objectifs.liste_eleves_objectifs, name='liste_eleves_objectifs'),
    path('classes/<int:classe_id>/eleves-objectifs-nosidebar/', views_transfert_eleves.liste_eleves_objectifs_nosidebar, name='liste_eleves_objectifs_nosidebar'),
    path('eleves/<int:eleve_id>/transferer/', views_transfert_eleves.transferer_eleve, name='transferer_eleve'),
    
    # Admin - Objectifs élèves
    path('gestion/objectifs/', views_eleves_objectifs.admin_liste_eleves_objectifs, name='admin_liste_eleves_objectifs'),
    path('gestion/objectifs/<int:classe_id>/', views_eleves_objectifs.admin_liste_eleves_objectifs, name='admin_liste_eleves_objectifs'),
    ...
    path('paiements/historique/<int:historique_id>/modifier/', main_views.modifier_historique_paiement, name='modifier_historique_paiement'),
    path('paiements/historique/<int:historique_id>/supprimer/', main_views.supprimer_historique_paiement, name='supprimer_historique_paiement'),
    path('saisie_paiement/', views_comptabilite.saisie_paiement, name='saisie_paiement'),
    path('statistiques_paiements/', views_comptabilite.statistiques_paiements, name='statistiques_paiements'),
    ...
    # URLs compatibles pour les templates
    path('presences/', views_presence.liste_presences_eleves, name='liste_presences'),
    path('presences/saisie/', views_presence.ajouter_presence_eleve, name='saisie_presences'),
    path('presences/statistiques/', views_presence.liste_presences_eleves, name='statistiques_presences'),
    ...
    path('professeurs/presence/<int:presence_id>/modifier/', views_presence_professeur.modifier_presence_professeur, name='modifier_presence_professeur'),
    path('professeurs/presence/<int:presence_id>/supprimer/', views_presence_professeur.supprimer_presence_professeur, name='supprimer_presence_professeur'),
    ...
    path('api/eleves-par-classe/<int:classe_id>/', views_api.eleves_par_classe, name='api_eleves_par_classe'),
    path('api/repetition/<int:repetition_id>/increment/', increment_repetition, name='increment_repetition'),
    path('api/repetition/<int:repetition_id>/decrement/', decrement_repetition, name='decrement_repetition'),
    ...
    path('objectifs/gestion/', views_objectifs_eleve.gestion_objectifs, name='gestion_objectifs'),
    
    # Progression Coran
    path('progression-coran/ajouter/', views_objectifs.ajouter_progression_coran, name='ajouter_progression_coran'),
